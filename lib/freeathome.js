...
module.exports = class FreeAtHomeApi {
    ...
    async addDeviceToioBroker(device) {
        ...
        await this.adapter.setStateAsync(serialNumber + '.deviceId', { val: device.deviceId, ack: true });
        ...
        if (device.channels) {
            ...
            for (const channel in channels) {
                ...
                for (const datapoint in channelData.datapoints) {
                    ...
                    await this.adapter.setStateAsync(ioObject, { val: datapointData, ack: true });
                }
            }
        }
    }
